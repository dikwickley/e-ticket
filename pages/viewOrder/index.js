...
export default function viewOrder() {
  ...
  return (
    <>  
     <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-3xl text-center"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Total Order Data</span></h1>
      <div className="overflow-x-auto relative shadow-md sm:rounded-lg ">
    
          {Object.keys(da.data).map((keyName, i) => (
            <>
                <h4 class="text-2xl font-bold dark:text-white text-center">{i+1} ORDER</h4>
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 mx-5 my-5 border-separate border border-slate-400">
                    ...
                    <h4 class="text-2xl font-bold dark:text-white">&nbsp; Participants Data : </h4>
                    ...
                    <h4 class="text-2xl font-bold dark:text-white">&nbsp; Events Detail : </h4>
                    <tr>
                      <th scope="col" className="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        Event Name
                      </th>
                      <th scope="col" className="py-3 px-6">
