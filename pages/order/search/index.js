...
export default function SearchOrder() {
  ...
  const handleSearchByCollegeId = () => {
    console.log(data);

    let fields = ["collegeid"];
    ...
    router.push(`/order/search/collegeid/${data["collegeid"]}`);
  };

  const handleSearchByDeskId = () => {
    console.log(data);
    ...
    router.push(`/order/search/deskid/${data["deskid"]}`);
  };
  ...
  const handleResend = async () => {
    ...
    let res = await fetch(`/api/order/resend/${data["orderid"]}`);
    res = await res.json();
        ...
        <div className="mt-10 sm:mt-0 lg:w-[70%] mx-auto p-10">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm text-gray-600">Get All Orders</p>
              </div>
            </div>
          ...
          <div className="my-6 md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">
                  Search Student OrderID
                </h3>
                <p className="mt-1 text-sm text-gray-600">
                  Get OrderID by CollegeID
                </p>
              </div>
            </div>
            <div className="mt-5 md:col-span-2 md:mt-0">
              <div className="overflow-hidden shadow sm:rounded-md">
                ...
                <div className="flex justify-end py-3 text-right items-centerpx-4 bg-gray-50 sm:px-6">
                  <button
                    type="submit"
                    onClick={handleSearchByCollegeId}
                    className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Search
                  </button>
          ...
          <div className="my-6 md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Resend Email to all participants
                </p>
              </div>
            </div>
            <div className="mt-5 md:col-span-2 md:mt-0">
              <div className="overflow-hidden shadow sm:rounded-md">
                ...
                <div className="flex justify-end py-3 text-right items-centerpx-4 bg-gray-50 sm:px-6">
                  <button
                    ...
                    className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Resend
                  </button>
                  {loading && (
